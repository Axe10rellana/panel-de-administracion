<?php
  session_start();
  $url_base = "http://localhost/proyectos/panel-de-administracion/";
...
<html lang="es">
  <head>
   <meta charset="UTF-8" />
    ...
    <link rel="icon" href="<?php echo $url_base; ?>src/assets/icons/favicon.png" />
    <link rel="favicon" href="<?php echo $url_base; ?>src/assets/icons/favicon.png" />
    <link rel="apple-touch-icon" href="<?php echo $url_base; ?>src/assets/icons/favicon.png" />
